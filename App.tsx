          ...
          {tabs.map((tab) => {
            ...
            return (
              <button
                ...
                className={`p-4 flex flex-col items-center gap-1 transition-colors ${activeTab === tab.id
                  ...
                  {parsedScenario?.errors.length > 0 && (
                    <div className="mb-4 space-y-2">
                      {parsedScenario.errors.map((error, index) => (
                        <div
                          key={index}
                          className={`p-3 rounded-lg flex items-start gap-2 ${error.severity === 'error'
  ...
  return (
    <div className="max-w-4xl mx-auto">
      <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-6">
        FHIR Gherkin and ITB Compiler Help
      </h2>
